<?php
  ...
  $query="select title, thumbnail_link, channelTitle, max(view_count) view_count, likes from youtube group by title order by view_count desc limit 100;";
...
<html>
  ...
  <body>
    ...
    <nav id="topMenu" >
      <ul>
        <li><a class="mainmenuLink" href="index.php">HOME</a></li>
        <li class="menu2">
