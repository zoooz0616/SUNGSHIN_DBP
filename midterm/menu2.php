<?php
  ...
  $query="select title, thumbnail_link, channelTitle, max(view_count) view_count, likes from youtube where categoryID=2 group by title order by view_count desc limit 100;";
